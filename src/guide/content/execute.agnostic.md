...
Two cautions. Crash-report retention differs between device platforms — on
some, reports age out of a device log within minutes; on others they persist as
files for weeks. That is why `crash list` scopes to the current session by
