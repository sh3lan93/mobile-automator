...
- If that install fails because a different build of {{app_package}} is already on the device, run `mauto uninstall {{app_package}}`, install again, and report that app data was wiped.
